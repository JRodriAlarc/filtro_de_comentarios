...
(async () => {
    ...
    /*
    const nuevoComentario = "Hola soy un nuevo comentario";
    const comentarioProcesado = preprocesarComentario(nuevoComentario);
    
    if (comentarioProcesado !== null) {
        const etiqueta = await predecirComentario(comentarioProcesado);
        console.log(`El comentario: '${nuevoComentario}', se clasifica como: ${etiqueta}`);
    }else{
        console.log("Intenta de nuevo en un rato...");
    }
    */
})();